...
exports.run = async function(ctx){
  ...
  try {
    ...
    // "photo" is a plain checkbox item (no file upload) under Identity & application, which is
    // grouped into the merged 'idFinancialDocs' session — index 2 (0: aboutYou, 1:
    // financialReadiness, 2: idFinancialDocs) — same session used by the passport-repetition-collapse
    // test.
