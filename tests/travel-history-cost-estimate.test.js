...
exports.run = async function(ctx){
  ...
  try {
    ...
    await page.waitForTimeout(50);
    var kenyaText = await page.$eval('#teCountryGuide', function(el){ return el.textContent; });
    ...
    await page.waitForTimeout(50);
    var zaText = await page.$eval('#teCountryGuide', function(el){ return el.textContent; });
